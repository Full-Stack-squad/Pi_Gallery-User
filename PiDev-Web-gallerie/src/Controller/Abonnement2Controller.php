...
class Abonnement2Controller extends AbstractController
{
    ...
    {
        return $this->render('abonnement2/Followers.html.twig', [
            'abonnement2s' => $abonnementRepository->findAll(),
        ]);
    }

    /**
     * @Route("/{id}", name="sb", methods={"GET"})
     */
    public function showbk(Abonnement2 $abonnement2): Response
    {
        return $this->render('abonnement2/showback.html.twig', [
